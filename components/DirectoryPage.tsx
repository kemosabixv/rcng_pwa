...
import { Search, Mail, Phone, Building2, MapPin, Loader2, Users, Shield } from 'lucide-react';
...
export function DirectoryPage() {
  ...
  const fetchMembers = async () => {
    try {
      ...
      const response = await fetch(`https://${projectId}.supabase.co/functions/v1/make-server-b2be43be/members`, {
        headers: {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Get to know the dedicated professionals who make up our Rotary Club family
            </p>
          </div>
          ...
          <div className="max-w-2xl mx-auto text-center">
            <Card className="border-2 border-blue-200 bg-blue-50">
              <CardContent className="pt-8">
                ...
                <h2 className="text-2xl font-bold mb-4">Member Access Required</h2>
                <p className="text-muted-foreground mb-6">
                  The member directory is available exclusively to registered members. 
                  Please sign in to access detailed member information and contact details.
                </p>
                <Alert className="mb-6">
                  <AlertDescription>
                    Below is a preview of our member community. Sign in to view complete profiles and contact information.
                  </AlertDescription>
                </Alert>
              </CardContent>
            </Card>
          ...
          <div className="mt-12">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold mb-4">Meet Some of Our Members</h3>
              <p className="text-muted-foreground">A glimpse into our diverse professional community</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <Card className="text-center">
              <CardContent className="pt-6">
                ...
                <div className="text-sm text-muted-foreground">Professions Represented</div>
              </CardContent>
            </Card>
            <Card className="text-center">
              <CardContent className="pt-6">
                <div className="text-3xl font-bold text-green-600 mb-2">
                  {Math.round(members.reduce((acc, m) => {
                    const years = new Date().getFullYear() - new Date(m.joinDate).getFullYear();
                    return acc + years;
                  }, 0) / members.length)}
                </div>
                <div className="text-sm text-muted-foreground">Years Average Membership</div>
              </CardContent>
            </Card>
          </div>
        )}
                ...
                <CardContent className="pt-6">
                  <div className="text-center mb-4">
                    ...
                    <Badge variant="secondary" className="mb-2">
                      {member.memberType === 'admin' ? 'Board Member' : 'Active Member'}
                    </Badge>
                    <p className="text-sm text-muted-foreground">{member.profession}</p>
                  </div>
        ...
        <div className="text-center mt-16">
          <Card className="bg-gradient-to-r from-red-50 to-pink-50 border-none max-w-2xl mx-auto">
            <CardContent className="pt-8">
              ...
              <p className="text-muted-foreground mb-6">
                Interested in becoming a member? Connect with our diverse group of professionals 
                committed to service and fellowship.
              </p>
